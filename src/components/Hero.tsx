        ...
        <div className="flex-1 text-center md:text-left animate-slide-up">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-3">
            {profile.socials.map((s) => {
              ...
              return (
                <a
                  ...
                  aria-label={s.label}
                  className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 text-sm text-gray-700 dark:text-gray-300 hover:border-accent-400 hover:text-accent-600 dark:hover:text-accent-400 transition-colors"
                >
                  <Icon size={16} />
                  <span>{s.label}</span>
                </a>
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg bg-accent-600 hover:bg-accent-700 text-white text-sm font-medium transition-colors"
            >
              <Mail size={16} />
              <span>Liên hệ</span>
            </a>
